...
const ContactSection = () => {
    ...
    return (
        <section className="relative w-full pb-32 bg-[#0B1120] overflow-hidden" id="contact">
            <div className="relative z-10 container mx-auto px-4 pt-8">
                <div className="relative w-full max-w-[1400px] mx-auto">
                    <NetworkTrunk className="-top-24 left-1/2 -translate-x-1/2 w-32 h-24" />
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-30">
                        <CloudRouter label="INGRESS_GATEWAY" direction="up" />
                    </div>

                    <div className="relative border border-emerald-500/20 bg-slate-900/20 rounded-3xl p-6 md:p-12 shadow-2xl backdrop-blur-sm">
