...
const SocialButton = ({ icon, label, href, color, delay }) => (
    <motion.a
        href={href}
        target="_blank"
        rel="noopener noreferrer"
        className={`flex items-center gap-3 p-4 rounded-2xl ${color} bg-opacity-10 hover:bg-opacity-20 transition-all border border-transparent hover:border-current`}
    ...
    return (
        <div className="col-span-12 grid grid-cols-2 md:grid-cols-4 gap-4 mt-2">
            ...
            <SocialButton
                ...
                label="GitHub"
                color="text-slate-800 bg-slate-800"
                delay={0.5}
                icon={
